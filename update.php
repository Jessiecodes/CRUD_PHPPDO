...
$msg = '';
// check if the contact if exists for example updata.php?id=2

if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        // This part is simimlar to the create.php but instead  we update a record and not insert
    ...
    // Get the contact from contacts table 
